<div style="background-color:#0C2D48;">
<div class="container p-5">
<div class="container">
	<div class="row mt-4">
		<div class="col">
			<div class="card">
				<h5 class="card-header" style="color : white">Checkout Success</h5>	
				<div class="card-body">
					...
					<ol>
						<li>Make payment to the account <strong>BCA 0123456789</strong> SOVA Store</li>
